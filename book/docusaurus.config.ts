...
const config: Config = {
  ...
  presets: [
    [
      'classic',
      {
        ...
        // MOVED HERE: Google Analytics configuration (was in themeConfig before)
        googleAnalytics: {
  ...
  themeConfig: {
    ...
    // Algolia search - Remove this entire block if you're not using Algolia
    // Or get real credentials from https://docsearch.algolia.com/
    algolia: {
    ...
    // REMOVED: googleAnalytics is no longer here - it's now in preset options above
    footer: {
      style: 'dark',
      links: [
        {
